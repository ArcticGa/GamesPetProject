...
const SearchGamesComponent = ({
	...
	return (
		activeSearch && (
			<div className='absolute top-0 left-70 max-h-[820px] no-scrollbar overflow-auto w-100 rounded-2xl bg-main-blocks p-2.5 z-50 max-sm:top-35 max-sm:left-0 max-lg:border-1 max-lg:border-links-and-borders max-sm:w-97 max-sm:max-h-[520px]'>
